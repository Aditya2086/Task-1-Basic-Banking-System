...
<div class="container">
        <h2 class="text-center pt-4" style="color : white; background-color:#32383e;">TRANSFER MONEY</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #21b954;" style="border-radius:0%;">Proceed</button></a></td> 
                    </tr>
                <?php
                $cnt=$cnt+1;
                    }
         ...
         <footer class="text-center mt-5 py-2">
            <p>&copy 2022 MADE BY <b>ADITYA PRATAP SINGH CHAUHAN</b></p>
        </footer>
